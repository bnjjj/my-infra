...
import { PackXdslWidgetContentComponent } from '../pack-xdsl-widget/content/pack-xdsl-widget-content';
...
@Component({
  ...
  directives: [
    ...
    PackXdslWidgetContentComponent
  ],
